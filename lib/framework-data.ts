...
export const frameworkSections: FrameworkSection[] = [
  {
    ...
    details: "Addresses sexual concerns and dysfunctions through counselling and clinical support. It aims to improve sexual well-being and satisfaction by addressing psychological, emotional, and physical factors affecting sexual function.",
  },
  {
    id: 1,
  ...
  },
  {
    ...
    details: "Focuses on the prevention, diagnosis, treatment, and care of HIV and other sexually transmitted infections. Strategies include promoting safer sex, testing and counselling, access to antiretroviral therapy, and linking HIV services with other sexual and reproductive health services.",
  },
  {
    id: 4,
    name: "Fertility care",
  ...
  },
  {
    ...
    details: "Ensures that individuals and couples have access to information and a range of contraceptive methods to make voluntary and informed decisions about their reproductive lives. This includes counselling on effectiveness, side effects, and correct use.",
  },
  {
    id: 7,
    name: "Gender-based violence prevention, support & care",
    details: "Focuses on preventing and responding to gender-based violence through health, education, and social support systems. It includes clinical care for survivors, counselling, and programmes to challenge harmful gender norms.",
  },
];
